...
(3, 'Dog', 'Bruno', 'Labrador Retriever', 3, 'Male', 'Golden', 28.5, 'Friendly, Active, Great with kids', 'Kochi, Kerala', 'pet3.jpg', 'Pedigree dry food, chicken, rice, occasional treats', 'Requires daily walks (at least 2x a day). Gets anxious if left alone for too long.', TRUE, FALSE),
(3, 'Dog', 'Max', 'German Shepherd', 2, 'Male', 'Black and Tan', 32.0, 'Loyal, Protective, Intelligent', 'Mumbai, Maharashtra', 'pet5.jpg', 'Royal Canin, raw meat, vegetables', 'Needs experienced owner. Excellent guard dog.', TRUE, FALSE),
(5, 'Cat', 'Whiskers', 'Persian', 2, 'Female', 'White', 4.2, 'Calm, Gentle, Indoor cat', 'Delhi, Delhi', 'pet2.jpg', 'Royal Canin, wet food, treats', 'Prefers quiet environment. Loves to be brushed daily.', TRUE, FALSE),
(5, 'Cat', 'Luna', 'Siamese', 1, 'Female', 'Cream', 3.8, 'Playful, Vocal, Social', 'Chennai, Tamil Nadu', 'pet10.jpg', 'Hills Science Diet, fish, chicken', 'Very talkative. Needs attention and playtime.', TRUE, FALSE),
(3, 'Bird', 'Charlie', 'African Grey Parrot', 1, 'Male', 'Grey', 0.5, 'Intelligent, Talkative, Social', 'Bangalore, Karnataka', 'pet7.jpg', 'Seeds, fruits, vegetables, nuts', 'Can mimic human speech. Needs mental stimulation.', TRUE, FALSE),
